...
![Github workfloat status](https://img.shields.io/github/workflow/status/kitsudaiki/libKitsunemimiObj/build-and-test/develop?label=build%20and%20test&style=flat-square)
