...
get_required_kitsune_lib_repo "libKitsunemimiCommon" "0.15.1" 4 "staticlib"
...
if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiObj" 1 "staticlib run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiObj" 1 "staticlib"
fi
